...
import (
	"os"
	"os/signal"
	"service-worker-sqs-sns-postgres/config/cmd/builder"
	cases "service-worker-sqs-sns-postgres/core/usecases/events"
	repository "service-worker-sqs-sns-postgres/dataproviders/postgres/repository/events"
	"service-worker-sqs-sns-postgres/dataproviders/server"
	"service-worker-sqs-sns-postgres/entrypoints/controllers/events"
	"syscall"
)
...
func main() {
	...
	logger.Info("Starting service-worker-sqs-sns-postgres ...")
	...
	logger.Info("service-worker-sqs-sns-postgres ended")
